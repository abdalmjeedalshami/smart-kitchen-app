...
class AppColors {
  ...
  static const Color transparentCharcoal = Color(0x73090909); // Meal page filter
  ...
  static const Color softWhite  = Color(0xFFFAFAFA); // Search field background & Horizontal meal card #FAFAFA
  ...
  static const Color deepTransparentBlack  = Color(0xA6000000); // Other sections in Meals screen #000000A6
  static const Color darkTransparentBlack  = Color(0x9C000000); // Normal text in single meal-2 screen #0000009C

  // Brown and Earthy Shades
  static const Color brownShade  = Color(0xFF7C6A46 ); // Disabled feature icon #7C6A46
  static const Color earthyBrown  = Color(0xFF8C7D5D); // Selected section in Meals screen #8C7D5D
